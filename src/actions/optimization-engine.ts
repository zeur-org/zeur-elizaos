...
export const OptimizationEngineAction: Action = {
    ...
    description: 'Analyzes market conditions and calculates optimal yield strategies across protocols',
    ...
    handler: async (
        ...
        try {
            ...
            const optimizedStrategy = await yieldOptimizer.optimizeAllocation(mockMarketData);
            ...
            if (callback) {
                callback({
                    ...
                    content: {
                        ...
                        improvement: optimizedStrategy.expectedAPR - currentStrategy.expectedAPR,
