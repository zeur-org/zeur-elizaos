...
export const PositionManagerAction: Action = {
    ...
    description: 'Manages and tracks DeFi position allocations across multiple staking protocols',
    ...
    handler: async (
        ...
        try {
            ...
            if (positions.size === 0) {
                response += "No positions currently tracked. Initializing portfolio monitoring...";
